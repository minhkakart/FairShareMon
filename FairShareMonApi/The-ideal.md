...
*   **Cách nhận mã QR:** cùng một tập "ai còn nợ" ở trên có thể lấy về theo hai cách — gom tất cả thành **một ảnh duy nhất**, hoặc lấy **từng mã QR riêng cho mỗi thành viên** (mỗi người một ảnh) để xem/chia sẻ lần lượt từng người. Cách trình bày là tùy chọn hiển thị; quy tắc "ai bị tính nợ" và số tiền không đổi.
