...
namespace FairShareMonApi.Migrations
{
    ...
    [Migration("20260825095114_AddEventMemberSettlementClearedAmount")]
    partial class AddEventMemberSettlementClearedAmount
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FairShareMonApi.Database.Entities.BankAccount", b =>
                {
                    b.Property<ulong>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint unsigned")
            ...
            modelBuilder.Entity("FairShareMonApi.Database.Entities.EventMemberSettlement", b =>
                {
                    ...
                    b.ToTable("event_member_settlements", null, t =>
                        {
                            t.HasCheckConstraint("ck_event_member_settlements_cleared_amount_non_negative", "cleared_amount >= 0");
                        });
                });

            modelBuilder.Entity("FairShareMonApi.Database.Entities.EventShareLink", b =>
                {
                    b.Property<ulong>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint unsigned")
                    ...
                    b.Property<string>("BankAccountUuid")
                        .HasMaxLength(64)
                        .HasColumnType("varchar(64)")
                        .HasColumnName("bank_account_uuid");
                    ...
                    b.ToTable("event_share_links", (string)null);
                });
