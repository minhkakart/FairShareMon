...
/// <summary>
/// Tag rename follows the same name policy as create (OQ6): required (whitespace-only rejected) and
/// at most 100 chars. The service trims the name before persisting.
/// </summary>
public class UpdateTagRequestValidator : AbstractValidator<UpdateTagRequest>
{
    public UpdateTagRequestValidator(IStringLocalizer<StringResources>? localizer = null)
    {
